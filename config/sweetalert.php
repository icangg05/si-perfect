...
return [
    ...
    */
    ...
    'button_text' => [
        ...
        'cancel' => env('SWEET_ALERT_CANCEL_BUTTON_TEXT', 'Kembali'),
    ],
    ...
    */
    ...
    'confirm_delete_confirm_button_color'   => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_COLOR', '#FF4857'),
    'confirm_delete_cancel_button_color'    => env('SWEET_ALERT_CONFIRM_DELETE_CANCEL_BUTTON_COLOR', '#d33'),
    'confirm_delete_cancel_button_text'     => env('SWEET_ALERT_CONFIRM_DELETE_CANCEL_BUTTON_TEXT', 'Kembali'),
